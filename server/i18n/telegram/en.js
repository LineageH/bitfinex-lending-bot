module.exports = {
  ...
  cmdHistorys: "List recent closed funding history",
  ...
  historysTitle: "Recent Closed Loans ({{symbol}})",
  historysUsage: "Usage: /historys [USD|USDT]",
  noFundingHistory: "No recent funding history",
  historysError: "An error occurred while fetching funding history.",
  newTransactionsTitle: "New {{symbol}} Transactions ({{count}})",
  closedTransactionsTitle: "Closed {{symbol}} Loans ({{count}})",
